...
function InventoryTable(props) {
   ...
   if (props.tradeDetails)
   {
    ...
    <form><input value={props.swap} onChange={props.swapInputChange} name="lemonades" type="text" width="10px" class="input1" placeholder="Amount"/><a currnum={props.tradeDetails["lemonades"]} class="waves-effect waves-light btn-small" onClick={props.swapFormSubmit}>Place Up For Trade</a></form>]);
    ...
    <form><input value={props.swap} onChange={props.swapInputChange} name="peanut_butter_patties" type="text" width="10px" class="input1"  placeholder="Amount"/><a currnum={props.tradeDetails["peanut_butter_patties"]} class="waves-effect waves-light btn-small" onClick={props.swapFormSubmit}>Place Up For Trade</a></form>]);
    ...
    <form><input value={props.swap} onChange={props.swapInputChange} name="peanut_butter_sandwich" type="text" width="10px" class="input1"  placeholder="Amount"/><a currnum={props.tradeDetails["peanut_butter_sandwich"]} class="waves-effect waves-light btn-small" onClick={props.swapFormSubmit}>Place Up For Trade</a></form>]);
    ...
    <form><input value={props.swap} onChange={props.swapInputChange} name="samoas" type="text" width="10px" class="input1"  placeholder="Amount"/><a currnum={props.tradeDetails["samoas"]} class="waves-effect waves-light btn-small" onClick={props.swapFormSubmit}>Place Up For Trade</a></form>]);
    ...
    <form><input value={props.swap} onChange={props.swapInputChange} name="shortbread" type="text" width="10px" class="input1"  placeholder="Amount"/><a currnum={props.tradeDetails["shortbread"]} class="waves-effect waves-light btn-small" onClick={props.swapFormSubmit}>Place Up For Trade</a></form>]);
    ...
    <form><input value={props.swap} onChange={props.swapInputChange} name="smores" type="text" width="10px" class="input1"  placeholder="Amount"/><a currnum={props.tradeDetails["smores"]} class="waves-effect waves-light btn-small" onClick={props.swapFormSubmit}>Place Up For Trade</a></form>]);
    ...
    <form><input value={props.swap} onChange={props.swapInputChange} name="thanks_a_lot" type="text" width="10px" class="input1"  placeholder="Amount"/><a currnum={props.tradeDetails["thanks_a_lot"]} class="waves-effect waves-light btn-small" onClick={props.swapFormSubmit}>Place Up For Trade</a></form>]);
